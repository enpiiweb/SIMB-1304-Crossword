...
$headers = "From: $email";
  ...
  mail('sales@veridon.com', $subject, $message, $headers);
  ?>
							<h4>Welcome aboard!</h4>
							<p>Thank you for your Application to enrol as a member of the Australian 
        Crossword Club. We have now received your details by email.</p>
							<p>All you have to do now is send a cheque or money order (payable in Australian 
        dollars) for the number of months until December 2005 @ $4.20 per month 
        (or $5.25 per month if outside Australia or same fees as within Australia 
        if <i>Crozworld</i> sent by e-mail) to:</p>
							<blockquote>
								<p><b>The Treasurer<br>
									</b><b>Australian Crossword Club<br>
									</b><b>PO&nbsp;Box 660, Wentworthville NSW 2145 Australia</b></p>
								<p><b>e-mail: <a href="mailto:ACC@tbmail.net">ACC@tbmail.net</a></b></p>
							</blockquote>
							<p>Upon receipt of your subscription you will be sent the latest copy of 
        the Club's monthly magazine, <i>Crozworld</i> and you can start solving 
        Australia's best crosswords straight away!</p>
							<p><b>Best of Luck with your solving!</b></p>
							<div align="left">
								<form name="Subscribe" action="/cgi/formemail.pl" method="post">
									<p></p>
	  ...
	  ?><!-- InstanceEndEditable --></td>
				...
				<tr>
					<td colspan=5>
						<div align="center">
							<font face="Arial, Helvetica, sans-serif">Copyright &copy; 2005-07 The Australian Crossword Club</font><br>
							<a href="http://www.veridon.com.au" target="_blank">website by veridon</a></div>
					</td>
				</tr>
			</table>
